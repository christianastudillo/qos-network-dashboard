...
/**
 * Set de iconos propio (estilo outline, sin dependencias externas) para
 * reemplazar los emojis usados en toda la app. Los paths son estáticos y
 * definidos en este archivo, por lo que confiarlos vía innerHTML es seguro.
 */
